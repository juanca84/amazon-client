                      ...
                      <div class="a-row a-spacing-small">
                        ...
                        <nuxt-link :to="`/products/${product._id}`" class="a-link-normal">
                          <h2 class="a-size-medium">
                            ...
                            <span class="a-letter-space"></span>
                            <span class="a-size-small a-color-secondary">Aug 6,2020</span>
                          </h2>
                        </nuxt-link>
                      </div>
                      <!-- Author´s name -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-5">
                          <div class="a-row a-spacing-mini">
                            <!-- Star Ratings -->
                            <no-ssr>
                              <star-rating :rating="product.averageRating" :show-rating="false" :glow="1" :border-width="1" :rounded-corners="true" :read-only="true" :star-size="18" :star-point="[23,2,14,17,0,19,10,34,7,50,23,43,38,50,36,34,46,19,31,17]"></star-rating>
                            </no-ssr>
                          </div>
                        </div>
                      </div>
